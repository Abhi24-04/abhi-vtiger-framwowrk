...
public class TC_18_CreateOpportunityWithSalesStageProposalOrPriceQuote_Test extends BaseClass
{
	@Test(groups = "smokeTest")
	public void A_createOrganization() throws Throwable
	{
		String orgName = exUtil.getExcelData("Organization", "tc_18", "OrganizationName")+"_"+ju.getRandomData();
	...
	public void createOpportunity_03() throws Throwable
	{
		
		    // Read data from excelsheet
	        String oppName = exUtil.getExcelData("Opportunities", "tc_18", "OpportumityName")+"_"+ju.getRandomData();
	        String salstg = exUtil.getExcelData("Opportunities", "tc_18", "Sales Stage");
	        String orgName = exUtil.getExcelData("Opportunities", "tc_18", "Related to");
