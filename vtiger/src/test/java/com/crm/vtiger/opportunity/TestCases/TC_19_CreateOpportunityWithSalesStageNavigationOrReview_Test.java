...
public class TC_19_CreateOpportunityWithSalesStageNavigationOrReview_Test extends BaseClass
{
	@Test(groups = "smokeTest")
	public void A_createOrganization() throws Throwable
	{
		String orgName = exUtil.getExcelData("Organization", "tc_19", "OrganizationName")+"_"+ju.getRandomData();
	...
	public void createOpportunity_04() throws Throwable
	{
		    // Read data from excelsheet
	        String oppName = exUtil.getExcelData("Opportunities", "tc_19", "OpportumityName")+"_"+ju.getRandomData();
	        String salstg = exUtil.getExcelData("Opportunities", "tc_19", "Sales Stage");
	        String orgName = exUtil.getExcelData("Opportunities", "tc_19", "Related to");
