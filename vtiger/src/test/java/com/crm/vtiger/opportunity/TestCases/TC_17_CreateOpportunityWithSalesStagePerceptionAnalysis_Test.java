...
public class TC_17_CreateOpportunityWithSalesStagePerceptionAnalysis_Test extends BaseClass
{
	@Test(groups = "smokeTest")
	public void A_createOrganization() throws Throwable
	{
		String orgName = exUtil.getExcelData("Organization", "tc_17", "OrganizationName")+"_"+ju.getRandomData();
	...
	public void createOpportunity_02() throws Throwable
	{
		    ...
		    String oppName = exUtil.getExcelData("Opportunities", "tc_17", "OpportumityName")+"_"+ju.getRandomData();
		    String salstg = exUtil.getExcelData("Opportunities", "tc_17", "Sales Stage");
		    String orgName = exUtil.getExcelData("Opportunities", "tc_17", "Related to");
